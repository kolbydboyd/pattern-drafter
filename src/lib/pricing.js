...
const GARMENT_TIERS = {
  ...
  'market-tote':                'simple',
  'beach-tote':                 'simple',
  // quick-win additions — $9
  'scrunchie':                  'simple',
  'mini-scrunchie':             'simple',
  'oversized-scrunchie':        'simple',
  'dog-bandana':                'simple',
  'zippered-pouch':             'simple',
  'makeup-bag':                 'simple',
  'pencil-case':                'simple',
  'pajama-pants':               'simple',
  'flannel-pajama-pants':       'simple',
  'satin-pajama-pants':         'simple',
  'lounge-shorts':              'simple',
  'turtleneck':                 'simple',
  'mock-neck':                  'simple',
  'dolman-top-w':               'simple',
  'maxi-skirt-w':               'simple',
  'maxi-skirt-elastic-w':       'simple',
  'maxi-skirt-zip-w':           'simple',
  'trapeze-dress-w':            'simple',
  // tailored — $19
...
const GARMENT_LABELS = {
  ...
  // quick-win additions
  'scrunchie':                  'Scrunchie',
  'mini-scrunchie':             'Mini Scrunchie',
  'oversized-scrunchie':        'Oversized Scrunchie',
  'dog-bandana':                'Dog Bandana',
  'zippered-pouch':             'Zippered Pouch',
  'makeup-bag':                 'Makeup Bag',
  'pencil-case':                'Pencil Case',
  'pajama-pants':               'Pajama Pants',
  'flannel-pajama-pants':       'Flannel Pajama Pants',
  'satin-pajama-pants':         'Satin Pajama Pants',
  'lounge-shorts':              'Lounge Shorts',
  'turtleneck':                 'Turtleneck',
  'mock-neck':                  'Mock Neck Top',
  'dolman-top-w':               'Dolman / Batwing Top',
  'maxi-skirt-w':               'Maxi Skirt',
  'maxi-skirt-elastic-w':       'Elastic Maxi Skirt',
  'maxi-skirt-zip-w':           'Side-Zip Maxi Skirt',
  'trapeze-dress-w':            'Trapeze Dress',
};
