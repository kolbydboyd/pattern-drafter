...
const SEO_DESCRIPTIONS = {
  ...
  'hiking-shorts': { metaDescription: 'Draft custom-fit hiking shorts from your measurements. Cargo pockets, drawstring waist, built for trail use in ripstop nylon. Tiled PDF.', pageIntro: 'Hiking shorts drafted to your waist, hip, and inseam. Cargo pockets and a drawstring waist make them ready for the trail in ripstop nylon or stretch nylon.', faq: [{ q: 'What fabric works best for hiking shorts?', a: 'Ripstop nylon or stretch nylon. Both shed light rain, dry fast, and resist snags on brush.' }, { q: 'Why cargo pockets and a drawstring?', a: 'Cargo pockets carry small essentials without a pack, and the drawstring adjusts easily mid-hike as layers change.' }] },
  'retro-short-trunks': { metaDescription: 'Generate custom-fit retro short swim trunks from your measurements. Slim 3-inch inseam, brief liner, side split hem. Tiled PDF.', pageIntro: 'Short-cut retro swim trunks with a slim fit, 3-inch inseam, built-in brief liner, and a side split hem. Drafted to your waist, hip, and rise.', faq: [{ q: 'How short is the inseam?', a: 'The inseam defaults to 3 inches for the retro mid-thigh silhouette. You can adjust it if you want a bit more coverage.' }, { q: 'What does the built-in liner do?', a: 'A lightweight mesh brief liner is sewn into the waistband so you don\u2019t need separate underwear for swimming.' }] },
