...
export default {
  ...
  pieces(m, opts) {
    ...
    if (opts.pockets === 'slant') {
      pieces.push(buildSlantPocketBacking({ bagWidth: 7, slashInset: 3.5, slashDepth: 7, bagDepth: 10, sa, instruction: 'Cut 2 (1 + 1 mirror) \xb7 Self fabric \xb7 Interface \xb7 Visible pocket front' }));
