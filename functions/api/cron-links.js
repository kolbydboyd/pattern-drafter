...
// Cloudflare Pages Function — scans published articles for internal linking opportunities.
...
export async function onRequest(context) {
  ...
  if (!articles || articles.length < 2) {
    return Response.json({ message: 'Not enough articles for linking', processed: 0 });
  }
  ...
  return Response.json({ updated, totalLinks, results });
}
